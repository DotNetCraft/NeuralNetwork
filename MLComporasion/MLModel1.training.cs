    ...
    public partial class MLModel1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=610,MinimumExampleCountPerLeaf=2,NumberOfTrees=751,MaximumBinCountPerFeature=1024,LearningRate=1F,FeatureFraction=1F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
